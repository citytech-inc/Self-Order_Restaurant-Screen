    ...
    <div className="sales-datas">
      <div className="sales-total">
        ...
        <p className="sales-type-price-customer">
          2886人<span className="additional-textred">(109.3%)</span>
        </p>
      </div>
      <div className="sales-total-flex">
        <div className="sales-total-half">
          ...
          <p className="sales-type-price-customer">
            71.2%<span className="additional-textred">(104.4%)</span>
          </p>
        </div>
        <div className="sales-total-half">
          ...
          <p className="sales-type-price-customersubtitle">構成比</p>
          <p className="sales-type-price-customer">
            28.8%<span className="additional-textblack">(97.2%)</span>
          </p>
        </div>
      </div>
      <div className="sales-total">
        ...
        <p className="sales-type-price-customer">
          ¥ 814.3<span className="additional-textblack">(98.1%)</span>
        </p>
      </div>
      <div className="sales-total">
        <p className="sales-type-text-gray">平均滞在時間</p>
        <p className="sales-type-price-customer">
          48.2分<span className="additional-textblack">(97.9%)</span>
        </p>
      </div>
      ...
      <div className="sales-total">
        ...
        <p className="sales-type-price-customer">
          ¥ 2,350,000<span className="additional-textred">(104.2%)</span>
        </p>
      </div>
    </div>
  </div>
